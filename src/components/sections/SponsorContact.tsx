            ...
            <GlassCard isHoverable={false} className="border-white/5 p-8 text-center space-y-6 bg-black/40">
              ...
              <div className="flex flex-col gap-3 pt-4 border-t border-white/[0.04]">
                ...
                <InteractiveButton
                  ...
                  onClick={() => handleSwitchView('sponsor', 'categories-section')}
                >
                  Become Sponsor
                </InteractiveButton>
                ...
                <InteractiveButton
                  ...
                  onClick={() => handleSwitchView('startup', 'startup-packages')}
                >
                  Reserve Startup Stall
                </InteractiveButton>

                <a
                  href="mailto:info@dominova.tech?subject=Schedule%20Meeting%20-%20Tech%20Aura%202026"
                ...
                <a
                  href="mailto:info@dominova.tech?subject=General%20Inquiry%20-%20Tech%20Aura%202026"
